...
public class Horsiper extends Monster implements GeoEntity
{
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public static final EntityDataAccessor<Integer> ATTACK = SynchedEntityData.defineId(Horsiper.class, EntityDataSerializers.INT);

    public Horsiper(EntityType<? extends Monster> entityType, Level level) { super(entityType, level); }
