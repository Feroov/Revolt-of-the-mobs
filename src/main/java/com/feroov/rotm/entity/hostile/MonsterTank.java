...
public class MonsterTank extends Monster implements GeoEntity
{
    ...
    public void performRangedAttack(LivingEntity livingEntity, float p_32142_)
    {
        ...
        this.playSound(SoundEventsROTM.TANK_SHOT.get(), 4.0F, 1.5F / (this.getRandom().nextFloat() * 0.4F + 0.8F));
