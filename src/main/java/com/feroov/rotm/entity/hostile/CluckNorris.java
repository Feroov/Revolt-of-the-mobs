...
public class CluckNorris extends Monster implements GeoEntity
{
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public static final EntityDataAccessor<Integer> ATTACK = SynchedEntityData.defineId(CluckNorris.class, EntityDataSerializers.INT);

    public CluckNorris(EntityType<? extends Monster> entityType, Level level) { super(entityType, level); }
    ...
    {
        private final CluckNorris entity;
        ...
        public CluckNorrisAttackGoal(CluckNorris horsiper, double speedIn, boolean longMemoryIn, int state)
        {
